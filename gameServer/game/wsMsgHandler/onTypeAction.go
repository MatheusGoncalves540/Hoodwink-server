...
import (
	...
	"github.com/MatheusGoncalves540/Hoodwink-gameServer/game/cardHandlers"
	"github.com/MatheusGoncalves540/Hoodwink-gameServer/game/room/roomStructs"
	"github.com/MatheusGoncalves540/Hoodwink-gameServer/game/wsMsgHandler/validators"
	"github.com/redis/go-redis/v9"
)

func OnTypeAction(evt *roomStructs.Event, ctx context.Context, rdb *redis.Client, room *roomStructs.Room) error {
	...
	case "use_assassin":
		...
		if err := cardHandlers.UseAssassin(ctx, rdb, room, evt); err != nil {
