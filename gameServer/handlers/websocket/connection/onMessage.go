...
func OnMessage(ctx context.Context, conn *websocket.Conn, rdb *redis.Client, registryRules *rules.Registry, playerPlay *roomStructs.PlayerPlay, roomData *rooms.Room) {
